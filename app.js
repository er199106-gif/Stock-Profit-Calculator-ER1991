...
// © ER1991 2026
// Version 2.1 - Reordered Layout + Clean Fields
...
class StockCalculator {
    ...
    generateReceipt() {
        ...
        ctx.roundRect(30, 230, width - 60, height - 320, 20);
        ctx.fill();
        ...
        if (data.commission > 0) {
            ...
            // إجمالي بالعمولة (بعد العمولة مباشرة)
            ctx.fillStyle = '#f59e0b';
        ...
        ctx.roundRect(50, y, width - 100, 140, 16);
        ctx.fill();
        ctx.shadowBlur = 0;
